...
const image = [/^image\/gif(;|$)/i, /^image\/jpeg(;|$)/i, /^image\/png(;|$)/i, /^image\/tiff(;|$)/i].concat(
    compressibleImage
);

const css = [/^text\/css(;|$)/i];

const javascript = [/^text\/javascript(;|$)/i, /^application\/javascript(;|$)/i, /^application\/x-javascript(;|$)/i];
